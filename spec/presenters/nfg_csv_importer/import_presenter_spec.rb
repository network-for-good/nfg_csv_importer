...
describe NfgCsvImporter::ImportPresenter do
  ...
  describe '#import_note' do
    let(:onboarding_session) { FactoryBot.create(:onboarding_session, :send_to_nfg_file_origination_type) }
  ...
  describe '#file_origination_type_name' do
    ...
    let(:import) { FactoryBot.create(:import, file_origination_type: tested_file_origination_type) }
