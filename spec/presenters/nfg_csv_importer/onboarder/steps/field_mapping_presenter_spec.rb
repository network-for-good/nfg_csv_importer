...
describe NfgCsvImporter::Onboarder::Steps::FieldMappingPresenter do
  let(:h) { NfgCsvImporter::Onboarding::ImportDataController.new.view_context }
  let(:field_mapping_presenter) { described_class.new(onboarding_session, h) }
  ...
  let(:current_step) { 'field_mapping' }
