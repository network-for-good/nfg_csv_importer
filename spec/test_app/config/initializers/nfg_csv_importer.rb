NfgCsvImporter.configure do |config|
  ...
  config.allowed_file_origination_types_to_bypass_max_row_limit = %i[ncoa_data_services_bulk_importer]
  config.high_priority_queue_name = :my_fine_queue
  config.process_import_job_sidekiq_options = { unique_for: 20.minutes }
