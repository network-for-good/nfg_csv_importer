...
describe "Running through the full import process", js: true do
  ...
  describe "from the new import page" do
    ...
    it "should be able to import users" do
      ...
      within("#importer_header_stats") do
        expect(page.text.squish).to have_content("1 IGNORED COLUMNS")
        expect(page.text.squish).to have_content("0 UNMAPPED COLUMNS")
        expect(page.text.squish).to have_content("Ready to import")
      end
