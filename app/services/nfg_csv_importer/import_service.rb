module NfgCsvImporter
  class ImportService
    ...
    def generate_stats_and_examples
      stats = (statistics_and_detail_generator || NfgCsvImporter::DefaultStatsGeneratorService).new(spreadsheet: spreadsheet, row_conversion_method: method(:convert_row_to_hash_with_field_mappings_as_keys_and_ignored_columns_removed)).call
    end
