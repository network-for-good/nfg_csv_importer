module NfgCsvImporter
  module Onboarder
    ...
    class NavigationBarPresenter < NfgCsvImporter::Onboarder::OnboarderPresenter
      ...
      # On the last step, provide nil to the requesting :href
      # to ensure the steps aren't rendered as <a> tags.
      # and thus, don't link anywhere semantically.
      def step_href(step, path)
        step == last_step ? nil : path
      end
      ...
      #
      # Example usage:
      # = ui.nfg :step, onboarder_presenter.step_status(the_step), step: 1, ...
