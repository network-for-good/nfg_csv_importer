    ...
    module ImportServiceable
      ...
      included do
        delegate :description, :required_columns, :optional_columns, :column_descriptions, :transaction_id,
          ...
          :rows_with_required_columns, :invalid_column_rules, :column_validation_rules, :can_be_viewed_by,
          :fields_that_allow_multiple_mappings, :can_be_deleted_by?, :attached_file, :preview_template,
          :populate_statistics, :to => :service
      end
